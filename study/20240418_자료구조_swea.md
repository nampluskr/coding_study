### [Linked List (작업중)] Doubly Linked List - find / insert / remove 구현 필요
...
int main(int argc, char* argv[])
{
    ...
    //list_insert(head, list_create(10));
    //list_insert(head, list_create(20));
    //list_insert(head, list_create(20));
    //list_insert(head, list_create(20));
    //list_insert(head, list_create(30));

    //printf(" %d", list_erase(head, 20));
